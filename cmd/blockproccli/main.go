...
import (
	...
	bpcmd "github.com/torresashjian/blockproc/cmd/blockproccli/commands"
...
func main() {
	...
	cmd := cli.PrepareMainCmd(BaseCli, "BPL", os.ExpandEnv("$HOME/.blockproccli"))
	cmd.Execute()
}
